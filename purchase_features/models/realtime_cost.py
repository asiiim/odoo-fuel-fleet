...
class ProductRealtimeCost(models.Model):
    ...
    cost_lines = fields.One2many(
        "product.realtime.cost.line", "realcost_id", string="Cost Details", copy=True
    )
...
class ProductRealtimeCostLine(models.Model):
    ...
    uom = fields.Many2one(
        related="product_id.uom_po_id", string="UoM", help="Unit of Measurement"
    )
